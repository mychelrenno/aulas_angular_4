...
const contato_detalhe_componemt_1 = require("./contato-detalhe.componemt");
const contatoRoutes = [
    {
        path: 'contato',
        component: contatos_lista_component_1.ConatosListaComponent
    },
    {
        path: 'contato/save',
        component: contato_detalhe_componemt_1.ContatoDetalheComponemt
    }
];
